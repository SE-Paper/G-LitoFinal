...
<html>
	...
	<body>
		...
		<div class="form-login" role="navigation">
			<ul>
                <a href="#list-regular" class="form-login" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>
				<li><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="list-regular" class="form-login" role="main">
            <h2 class="form-login-heading"><g:message code="default.list.label" args="[entityName]" /></h2>
