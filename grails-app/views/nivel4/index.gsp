...
<div id="wrapper">
	...
	<nav class="navbar-default navbar-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li>
					<a class="active-menu" href="${request.contextPath}/nivel4/index.gsp"><i class="fa fa-table"></i> Nivel 4</a>
				</li>
				<li>
	...
	<!-- / Luis Garcia: Inicia todo referente al Curso de Nivel 4 -->
			...
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-header">
						Nivel 4 <small>Experto con GroovyLito...</small>
					</h1>
				</div>
			</div>
			<!-- /. ROW  -->
