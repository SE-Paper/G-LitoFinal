...
<div id="wrapper">
	...
	<nav class="navbar-default navbar-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li>
					<a class="active-menu" href="${request.contextPath}/nivel1/index.gsp"><i class="fa fa-desktop"></i> Nivel 1</a>
				</li>
				<li>
	...
	<!-- / Luis Garcia: Inicia todo referente al Curso de Nivel 1 -->
			...
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-header">
						Nivel 1 <small>Comienza a GroovyLiarte...</small>
					</h1>
				</div>
			</div>
			<!-- /. ROW  -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="alert alert-success">
								<strong>Primer Tema!</strong> Que es Groovy...?.
							</div>
							<div class="alert alert-info">
								<strong>Segundo Tema!</strong> Por que Groovy?.
							</div>
							<div class="alert alert-warning">
								<strong>Tercer Tema!</strong> Como es Groovy?.
							</div>
							<div class="alert alert-danger">
								<strong>Cuarto Tema!</strong> Groovy en accion.
							</div>
						</div>
					</div>
				</div>
