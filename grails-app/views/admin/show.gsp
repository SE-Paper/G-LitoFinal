	...
	<body>
		...
		<div id="show-admin" class="content scaffold-show" role="main">
			...
			<ol class="property-list admin">
				...
				<li class="fieldcontain">
					<span id="lastName-label" class="property-label"><g:message code="admin.lastName.label" default="Last Name" /></span>
				...
				<g:if test="${adminInstance?.raiting}">
				<li class="fieldcontain">
					<span id="raiting-label" class="property-label"><g:message code="admin.raiting.label" default="Raiting" /></span>
					
						<span class="property-value" aria-labelledby="raiting-label"><g:fieldValue bean="${adminInstance}" field="raiting"/></span>
