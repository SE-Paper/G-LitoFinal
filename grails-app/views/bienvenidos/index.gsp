...
<head>
	...
	<link rel="stylesheet" href="${request.contextPath}/css/bootstrap.css" media="screen">
	<link rel="stylesheet" href="${request.contextPath}/skins/eden.css" media="screen">
	<link rel="stylesheet" href="${request.contextPath}/css/style.css" media="screen">
	<link href="${request.contextPath}/fonts/icons/icons.css" rel="stylesheet">
				...
				<div class="col-md-12">
					<div id="featured-slider" class="carousel slide" data-ride="carousel">
						...
						<ol class="carousel-indicators">
							<li data-target="#featured-slider" data-slide-to="0" class="active"><img src='${request.contextPath}/images/sliders/slider-1-t.jpg' alt='' class='featured-slide-thumb'  /></li>
							<li data-target="#featured-slider" data-slide-to="1" ><img src='${request.contextPath}/images/sliders/slider-2-t.jpg' alt='' class='featured-slide-thumb'  /></li>
							<li data-target="#featured-slider" data-slide-to="2" ><img src='${request.contextPath}/images/sliders/slider-3-t.jpg' alt='' class='featured-slide-thumb'  /></li>
							<li data-target="#featured-slider" data-slide-to="3" ><img src='${request.contextPath}/images/sliders/slider-4-t.jpg' alt='' class='featured-slide-thumb'  /></li>
						...
						<div class="carousel-inner" role="listbox">
							...
							<div class="item active" id="slide-2">
								<img src='${request.contextPath}/images/sliders/slider-2.jpg' alt='' class='featured-slide inv' data-animation = 'animated zoomIn' data-delay = '0.3s' />
								<img src='${request.contextPath}/images/sliders/slider-1.jpg' alt='' class='featured-slide featured-slide-1 inv' data-animation = 'animated zoomIn' data-delay = '0.7s' />
								<div class="carousel-caption">
									<span class="lead slide-cat inv"  data-animation="animated zoomIn"><a href="${request.contextPath}/nivel1/index.gsp" rel="category">Nivel 1</a></span>
							...
							<div class="item" id="slide-3">
								<img src='${request.contextPath}/images/sliders/slider-3.jpg' alt='' class='featured-slide inv' data-animation = 'animated zoomIn' data-delay = '0.3s' />
								<img src='${request.contextPath}/images/sliders/slider-2.jpg' alt='' class='featured-slide featured-slide-1 inv' data-animation = 'animated zoomIn' data-delay = '0.7s' />
								<div class="carousel-caption">
									<span class="lead slide-cat inv"  data-animation="animated zoomIn"><a href="${request.contextPath}/nivel2/index.gsp" rel="category">Nivel 2</a></span>
							...
							<div class="item" id="slide-4">
								<img src='${request.contextPath}/images/sliders/slider-4.jpg' alt='' class='featured-slide inv' data-animation = 'animated zoomIn' data-delay = '0.3s' />
								<img src='${request.contextPath}/images/sliders/slider-3.jpg' alt='' class='featured-slide featured-slide-1 inv' data-animation = 'animated zoomIn' data-delay = '0.7s' />
								<div class="carousel-caption">
									<span class="lead slide-cat inv"  data-animation="animated zoomIn"><a href="${request.contextPath}/nivel3/index.gsp" rel="category">Nivel 3</a></span>
							...
							<div class="item" id="slide-5">
								<img src='${request.contextPath}/images/sliders/slider-1.jpg' alt='' class='featured-slide inv' data-animation = 'animated zoomIn' data-delay = '0.3s' />
								<img src='${request.contextPath}/images/sliders/slider-4.jpg' alt='' class='featured-slide featured-slide-1 inv' data-animation = 'animated zoomIn' data-delay = '0.7s' />
								<div class="carousel-caption">
									<span class="lead slide-cat inv"  data-animation="animated zoomIn"><a href="${request.contextPath}/nivel4/index.gsp" rel="category">Nivel 4</a></span>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center section-intro">
				...
				<th align = "center"><a><img src="${request.contextPath}/images/logos/groovylito_logo1.png"   class="img-responsive center-block" width="350" heigth="350" ></a></th>
...
<footer>
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center section-intro">
				<hr/>
				<h2> <img src="${request.contextPath}/images/logos/groovylito_name.png"  class=" img-responsive center-block" width="300" heigth="300"/></h2>
...
<script src="${request.contextPath}/js/jquery-2.1.3.min.js"></script>
<script src="${request.contextPath}/js/bootstrap.min.js"></script>
<script src="${request.contextPath}/js/jquery.sticky.js"></script>
<script src="${request.contextPath}/js/wow.min.js"></script>
<script src="${request.contextPath}/js/site.js"></script>
