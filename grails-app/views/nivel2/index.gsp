...
<div id="wrapper">
	...
	<nav class="navbar-default navbar-side" role="navigation">
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li>
					<a class="active-menu" href="${request.contextPath}/nivel2/index.gsp"><i class="fa fa-bar-chart-o"></i> Nivel 2</a>
				</li>
				<li>
	...
	<!-- / Luis Garcia: Inicia todo referente al Curso de Nivel 2 -->
			...
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-header">
						Nivel 2 <small>GroovyLito en marcha...</small>
					</h1>
				</div>
			</div>
			<!-- /. ROW  -->
